...
// A more comprehensive opening book.
// Key: FEN string (position, active player, castling, en passant).
// Value: The AI's move in algebraic notation (e.g., "e7e5").
// We only need to store positions where it is the AI's (black's) turn to move.
